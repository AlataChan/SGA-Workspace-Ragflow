...
export default function TempKbDialog({
    ...
    switch (variant) {
      case 'sidebar':
        return (
          <Button
            variant="ghost"
            className="w-full justify-start text-muted-foreground hover:text-foreground hover:bg-muted/50 px-3 py-2"
          >
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl h-[92vh] flex flex-col bg-card border border-border p-0">
