        ...
        <div className="border-2 border-dashed border-border rounded-lg p-6 text-center bg-muted/30 hover:bg-muted/50 transition-colors">
          <div className="space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-foreground font-medium">{isUploading ? "正在上传..." : "点击选择图片"}</p>
              <p className="text-muted-foreground text-xs">上传后将自动生成展示照片和聊天头像</p>
            </div>
          </div>
          {/* 添加一个备用按钮 */}
          <button
            ...
            className="mt-2 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-sm rounded"
          >
            备用上传按钮
          </button>
        </div>
